...
import btrust.btrustOne.client.mandate.pagesObject.createMandate.pagesObject.EmailAndFormPage;
...
public class EmailAndFormTest extends BaseClientUserTest {

    @BeforeMethod
    public void enterToEmailAndFormRequiredScreen() {
