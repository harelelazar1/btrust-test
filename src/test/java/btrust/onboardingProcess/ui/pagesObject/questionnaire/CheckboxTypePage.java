...
public class CheckboxTypePage extends BasePage {
    public CheckboxTypePage(WebDriver driver) {
        super(driver);
    }
    ...
    @FindBy(css = ".TypeCheckbox_container__2Y4Z6 > li > .TypeCheckbox_radio__2W8gT")
    protected List<WebElement> checkboxList;
    @FindBy(css = ".TypeCheckbox_container__2Y4Z6 > li ")
