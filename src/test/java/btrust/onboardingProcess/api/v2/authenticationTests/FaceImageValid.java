...
public class FaceImageValid {
    ...
    @Test(description = "Onboarding Api Test bioID new Face Image Valid Authentication Fail")
    @Description("Onboarding Api Test bioID new Face Image Valid Authentication Fail")
    public void t01_bioIdNewFaceImageValidAuthFail() throws IOException, ParseException {
        sessionId = apiResponses.createSessionId(1345);

        apiResponses.initSessionNew(preProcess, 1345, sessionId, System.getProperty("COMPANY_ID"));
...
//        assertNotNull(preProcess.getSessionId());
        ...
        apiResponse.mainClientResponseNew(variables, "multipart/form-data", "Authorization",
                "Bearer " + variables.getToken(), "frame", new File("./ocr/new bioID/Gregory/newBioIdFrontFaceImageValid.jpg"),
        ...
        apiResponses.updateRequestPutCall(preProcess, 1345, preProcess.getMissingFields(), ocrCaseId, "sessionId", sessionId);
        ...
        assertFalse(ILID.isFaceImageReplacedWithPassportImage());
