...
public class ValidityExpiryDate {
    ...
    @Test(description = "Onboarding Api Test BlueId Validity Expiry Date Authentication Fail")
    @Description("Onboarding Api Test BlueId Validity Expiry Date Authentication Fail")
    public void t01_blueIdValidityExpiryDateAuthFail() throws IOException, ParseException {
        sessionId = apiResponses.createSessionId(1356);

        apiResponses.initSessionNew(preProcess, 1356, sessionId, System.getProperty("COMPANY_ID"));
...
//        assertNotNull(preProcess.getSessionId());
        ...
        apiResponse.mainClientResponseNew(variables, "multipart/form-data", "Authorization",
                "Bearer " + variables.getToken(), "frame", new File("./ocr/blueID/auth/blueID_Expiry_Date.jpg"),
        ...
        apiResponses.updateRequestPutCall(preProcess, 1356, preProcess.getMissingFields(), ocrCaseId, "sessionId", sessionId);
        ...
        assertEquals(ILID.getExpiryDate(), "28.01.2020");
        ...
        assertEquals(ILID.getExpirationDate(), "2020-01-28T00:00:00.000+0000");
    ...
    @Test(description = "Onboarding Api Test bioID Validity Expiry Date Authentication Fail")
    @Description("Onboarding Api Test bioID Validity Expiry Date Authentication Fail")
    public void t02_bioIdValidityExpiryDateAuthFail() throws IOException, ParseException {
        sessionId = apiResponses.createSessionId(1356);
...
//        assertNotNull(preProcess.getSessionId());
        ...
        apiResponse.mainClientResponseNew(variables, "multipart/form-data", "Authorization",
                "Bearer " + variables.getToken(), "frame", new File("./ocr/bioID/nimrod/Bio_Front_Expiry_Date.jpg"),
                "image/jpg", "message_type", "frame_request", apiResponse.CLIENT_REQUEST_OCR, sessionId, X_Session_Id, X_Request_Id);
        ...
        assertEquals(ILID.getIssuingDate(), "05.12.2021");
        assertEquals(ILID.getExpiryDate(), "01.12.2021");
        ...
        assertEquals(ILID.getExpirationDate(), "2021-12-01T00:00:00.000+0000");
        assertNotNull(ILID.getFaceImage());
        assertNotNull(ILID.getFrontImage());
        assertNotNull(ILID.getCardImage());
        assertEquals(ILID.getDocType(), "il_id_bio");
        assertEquals(ILID.getIssueDate(), "2021-12-05T00:00:00.000+0000");
        assertEquals(ILID.getPlaceOfBirth(), "ישראל");
        assertEquals(ILID.getCitizenship(),"אזרחות ישראלית");
        assertEquals(ILID.getOcrType(), "IL-ID");
    ...
    @Test(description = "Onboarding Api Test iLDL Validity Expiry Date Authentication Fail")
    @Description("Onboarding Api Test iLDL Validity Expiry Date Authentication Fail")
    public void t03_ilDLValidityExpiryDateAuthFail() throws IOException, ParseException {
        sessionId = apiResponses.createSessionId(1356);
...
//        assertNotNull(preProcess.getSessionId());
        ...
        apiResponse.mainClientResponseNew(variables, "multipart/form-data", "Authorization",
                "Bearer " + variables.getToken(), "frame", new File("./ocr/dl/auth/new/NewDlWithExpiryDate.jpg"),
                "image/jpg", "message_type", "frame_request", apiResponse.CLIENT_REQUEST_OCR, sessionId, X_Session_Id, X_Request_Id);
        while (!variables.getActionType().equalsIgnoreCase("stage")) {
            apiResponse.mainClientResponseNew(variables, "multipart/form-data", "Authorization",
                    "Bearer " + variables.getToken(), "frame", new File("./ocr/dl/auth/new/NewDlWithExpiryDate.jpg"),
        ...
        assertEquals(ILDL.getExpiryDate(), "26.03.2022");
        ...
        assertEquals(ILDL.getExpirationDate(), "2022-03-26T00:00:00.000+0000");
        ...
        assertTrue(ILDL.isBackTemplateMatching());
        assertTrue(ILDL.isChecksum());
        assertTrue(ILDL.isBackChecksum());
        ...
        assertTrue(ILDL.isDocumentInFrame());
        assertTrue(ILDL.isBackDocumentInFrame());
