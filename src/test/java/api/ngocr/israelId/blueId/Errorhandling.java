...
public class Errorhandling {
    ...
    @Test(description = "blue Id api - scan card with date of issue hidden")
    @Description("blue Id api - scan card with date of issue hidden")
    public void t03_blueId_dateOfIssueHidden() throws IOException {
        apiResponse.mainClientResponseNew(variables, "multipart/form-data", "Authorization",
                "Bearer " + variables.getToken(), "frame", new File("./ocr/blueID/errorhandling/blueIDWithDateOfIssueHidden.jpg"),
                "image/jpg", "message_type", "frame_request", apiResponse.CLIENT_REQUEST_OCR, sessionId, X_Session_Id, X_Request_Id);
    ...
    public void t04_blueId_dateOfExpiryHidden() throws IOException {
        apiResponse.mainClientResponseNew(variables, "multipart/form-data", "Authorization",
                "Bearer " + variables.getToken(), "frame", new File("./ocr/blueID/errorhandling/blueIDWithDateOfExpiryHidden.jpg"),
                "image/jpg", "message_type", "frame_request", apiResponse.CLIENT_REQUEST_OCR, sessionId, X_Session_Id, X_Request_Id);
...
//    @Test(description = "blue Id api - scan card with id number hidden")
    @Description("blue Id api - scan card with id number hidden")
    public void t05_blueId_idNumberHidden() throws IOException {
        apiResponse.mainClientResponseNew(variables, "multipart/form-data", "Authorization",
                "Bearer " + variables.getToken(), "frame", new File("./ocr/blueID/errorhandling/blueIDWithIdNumberHidden.jpg"),
                "image/jpg", "message_type", "frame_request", apiResponse.CLIENT_REQUEST_OCR, sessionId, X_Session_Id, X_Request_Id);
