...
public class Authentication {
    ...
    @Test(description = "new IL-DL api - scan card without face")
    @Description("new IL-DL api - scan card without face")
    public void t01_newILDL_pictureWithoutFace() throws IOException {
        ...
        apiResponse.verifyInitVariables(variables);
        apiResponse.mainClientResponse(variables, "multipart/form-data", "Authorization", "Bearer " + variables.getToken(), "frame", new File("./ocr/dl/errorhandling/newDl/newDLFront - WithoutFaceImage.jpg"), "image/jpg", "message_type", "frame_request", apiResponse.CLIENT_REQUEST_OCR);
