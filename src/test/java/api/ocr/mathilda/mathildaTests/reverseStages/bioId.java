...
public class bioId {
    ...
    @Test(description = "reverse stages e2e bio id")
    @Description("Bio id with reverse stages (back -> front) e2e run")
    public void t01_bioIdReverseStages() throws IOException {
        apiResponse.clientInitResponse(variables, "application/json", "caseId", apiResponse.randomString(), "libraryName", "IL-ID", "flowConfigName", "reverseStages.json", apiResponse.CLIENT_INIT_OCR);
