...
public class Functionality {
    ...
    @Test(description = "api new mrz front side timeout session")
    @Description("New MRZ end to end Api - front side timeout session")
    public void t02_frontSideNewMrzTimeout() throws InterruptedException, IOException {
