...
public class Authentication {
    ...
    @Test(description = "blue Id api - scan card without face",retryAnalyzer = utilities.RetryAnalyzer.class)
    @Description("blue Id api - scan card without face")
    public void t01_blueId_cardWithoutFaceImage() throws IOException {
        apiResponse.mainClientResponse(variables, "multipart/form-data", "Authorization", "Bearer " + variables.getToken(), "frame", new File("./ocr/blueID/blueID_hiddenFace.jpg"), "image/jpg", "message_type", "frame_request", apiResponse.CLIENT_REQUEST_OCR);
    ...
    public void t02_blueIdStampDetected() throws IOException {
        apiResponse.mainClientResponse(variables, "multipart/form-data", "Authorization", "Bearer " + variables.getToken(), "frame", new File("./ocr/blueID/auth/blueIdStampCovered.jpg"), "image/jpg", "message_type", "frame_request", apiResponse.CLIENT_REQUEST_OCR);
