...
public class Functionality {
    ...
    @Test(description = "green id api e2e front side timeout",retryAnalyzer = utilities.RetryAnalyzer.class)
    @Description("Green id end to end Api - front side timeout session")
    public void t01_e2eGreenId_frontSideTimeoutSession() throws InterruptedException, IOException {
