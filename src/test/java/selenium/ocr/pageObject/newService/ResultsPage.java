package selenium.ocr.pageObject.newService;
        ...
        for (WebElement el : resultsList) {
            ...
            switch (resultsKey) {
                ...
                case "passport_number":
                    if (variables.getCardType1().equalsIgnoreCase("israel_stay_permit")) {
                        variables.setPassportNumber1(resultsValue);
                    }else {
        ...
        for (WebElement imageEl : imagesList) {
            ...
            switch (resultsImageKey) {
                ...
                case "last_received_image":
                    ...
                    break;
                case "aligned_field":
                    variables.setAlignedField("aligned_field");
                    break;
                case "aligned_card":
                    variables.setAlignedCard("aligned_card");
                    break;
            }
        }
