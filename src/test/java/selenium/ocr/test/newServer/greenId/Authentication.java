...
public class Authentication extends BaseTest {
    ...
    @Test(description = "green Id demo - scan card without face")
    @Description("green Id demo - scan card without face")
    public void t01_greenId_cardWithoutFaceImage() throws IOException, InterruptedException {
        Injection injection = new Injection(driver);
        injection.imageInjection("./ocr/greenID/greenID_hiddenFace.jpg", 1, true);
    ...
    public void t02_greenIdStampDetected() throws IOException, InterruptedException {
        Injection injection = new Injection(driver);
 ...
 //       Assert.assertNotNull(variables.getCaseId());
    ...
    public void t03_greenIdFaceSizeInvalid() throws IOException, InterruptedException {
        Injection injection = new Injection(driver);
