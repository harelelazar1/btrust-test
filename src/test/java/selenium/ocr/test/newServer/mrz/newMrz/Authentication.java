...
public class Authentication extends BaseTest {
    ...
    @Test(description = "new mrz without face image")
    @Description("New mrz without face image")
    public void t01_newMrzWithoutFace() throws IOException, InterruptedException {
        injection.imageInjectionConfigure("./ocr/mrz/nadav/nadavMrzWithoutFace.jpg", null, 1, false, null);
    ...
    public void t02_newMrzWithFaceSizeInvalid() throws IOException, InterruptedException {
        injection.imageInjectionConfigure("./ocr/mrz/nadav/nadavMrzWithFaceSizeInvalid.jpg", null, 1, false, null);
    ...
    public void t03_newMrzWithFaceRotation() throws IOException, InterruptedException {
        injection.imageInjectionConfigure("./ocr/mrz/nadav/nadavMrzWithFaceRoatation.jpg", null, 1, false, null);

        ResultsPage resultsPage = new ResultsPage(driver);
        Assert.assertEquals(resultsPage.verifyListsSizes(10), 28);
        resultsPage.collectResults(variables);
