...
public class Functionality extends BaseTest {
    ...
    public void t01_e2eOldMrzFrontSideTimeout() throws InterruptedException {
    ...
    @Test(description = "old mrz e2e run without cPalette inspection")
    @Description("old mrz e2e run without cPalette inspection using the config file - qa_config.json")
