...
public class Authentication extends BaseTest {
    ...
    @Test(description = "bio id with chip covered")
...
//        Assert.assertNotNull(variables.getCaseId());
    ...
    @Test(description = "bio Id demo - scan card without face")
    @Description("bio Id demo - scan card without face")
    public void t02_bioId_cardWithoutFaceImage() throws IOException, InterruptedException {
        Injection injection = new Injection(driver);
        injection.imageInjectionConfigure("./ocr/bioID/nitzan/front/NitzanBioFrontWithoutFace.jpg", "./ocr/bioID/nitzan/back/NitzanBioBack1.jpg", 1, false, null);
   ...
   //     Assert.assertNotNull(variables.getCaseId());
    ...
    @Test(description = "bio Id demo - scan card with face size invalid")
    @Description("bio Id demo - scan card with face size invalid")
    public void t03_bioId_cardWithFaceSizeInvalid() throws IOException, InterruptedException {
        Injection injection = new Injection(driver);
...
//        Assert.assertNotNull(variables.getCaseId());
    ...
    @Test(description = "bio Id demo - id number no matches front")
    @Description("Bio Id demo - front and back id numbers are not matches each other")
    public void t04_bioId_idNumberNoMatchesFront() throws IOException, InterruptedException {
        Injection injection = new Injection(driver);
