...
public class Errorhandling extends BaseTest {
    ...
    public void t04_OldDl_wrongSideMessage() throws IOException, InterruptedException {
        Injection injection = new Injection(driver);
        Assert.assertTrue(injection.imageInjectionConfigure("./ocr/dl/oldDLBack.jpg", null, 1, true, "Wrong side"));
        Thread.sleep(85000);
    ...
    public void t06_OldDl_dateOfIssueHidden() throws IOException, InterruptedException {
        Injection injection = new Injection(driver);
        injection.imageInjectionConfigure("./ocr/dl/errorhandling/oldDl/oldDLFront - dateOfIssueHidden.jpg", null, 1, false, null);
        ResultsPage resultsPage = new ResultsPage(driver);
